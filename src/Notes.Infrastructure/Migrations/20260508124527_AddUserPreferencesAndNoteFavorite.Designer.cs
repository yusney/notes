...
namespace Notes.Infrastructure.Migrations
{
    ...
    [Migration("20260508124527_AddUserPreferencesAndNoteFavorite")]
    partial class AddUserPreferencesAndNoteFavorite
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Notes.Domain.Entities.UserPreferences", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Notes.Domain.Entities.UserPreferences", b =>
                {
                    b.HasOne("Notes.Domain.Entities.User", null)
                        .WithOne()
                        .HasForeignKey("Notes.Domain.Entities.UserPreferences", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
